...
dgp.f.name="6-dgp-binaryM-binaryZ-interAZ.R" # name for the DGP function
truth = "6-truth-binaryM-binaryZ-interAZ.Rdata" # name for the truth.Rdata
...
for (i in seq_along(n.vec)){
  ...
  for (t in 1:nsim){
    ...
    job <- paste0("Rscript main.R ",n.vec[i]," ",t," ", dgp.f.name," ", truth," ",out.path.TMLE," ", out.path.Onestep)
